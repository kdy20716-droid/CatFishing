...
export const FISH_SPECIES = [
  ...
  },
  {
    ...
    baseExp: 350,
    sizeRange: [40, 60],
    favBait: ['bread', 'worm', 'shrimp', 'lure', 'jelly', 'pearl', 'golden'],
    baitSize: 'large',
    speed: 0,
    strength: 90,
  ...
  },
  {
    ...
    speed: 40,
    strength: 70,
    description: '거대한 펠리칸 부리 같은 주둥이와 꼬리 끝 발광 기관으로 심해 먹이를 한입에 삼킵니다.',
    colors: { body: '#1a1a2e', belly: '#16213e', fin: '#0f3460' },
    drawType: 'ribbon'
  },
  {
    id: 'vampire_squid',
    name: '심해 흡혈 오징어',
    engName: 'Deep Vampire Squid',
    zone: 'deep',
    minDepth: 140,
    maxDepth: 250,
    rarity: 'rare',
    ...
    speed: 55,
    strength: 65,
    description: '검붉은 망토 같은 지느러미와 신비로운 형광 발광을 내뿜는 심해의 드라큘라 오징어.',
    colors: { body: '#800f2f', tentacle: '#a4133c', glow: '#ff4d6d' },
    drawType: 'squid'
  },
  ...
  },
  {
    ...
    baseExp: 310,
    sizeRange: [15, 30],
    favBait: ['lure', 'golden', 'jelly'],
    baitSize: 'medium',
    speed: 30,
    strength: 75,
    description: '투명한 돔 머리 속에 초록빛 원통형 눈을 품고 심해 위쪽의 먹이를 감시하는 신비로운 심해어.',
    colors: { body: '#0a192f', nose: '#06d6a0', mouth: '#64dfdf' },
    drawType: 'blobfish'
  },
  {
    id: 'dumbo_octopus',
    name: '귀염둥이 덤보문어',
    engName: 'Cute Dumbo Octopus',
    zone: 'abyss',
    minDepth: 280,
    maxDepth: 400,
    rarity: 'rare',
    ...
    baseExp: 260,
    sizeRange: [20, 45],
    favBait: ['lure', 'golden', 'shrimp', 'jelly'],
    baitSize: 'medium',
    speed: 35,
    strength: 70,
    description: '코끼리 귀 같은 지느러미를 펄럭이며 우아하고 귀엽게 심연을 유영하는 덤보문어.',
    colors: { body: '#ffb3c6', tentacle: '#ff8fab', glow: '#fb6f92' },
    drawType: 'squid'
  },
  ...
  },
  {
    id: 'hadal_snailfish',
    name: '마리아나 꼼치',
    engName: 'Mariana Hadal Snailfish',
    zone: 'hadal',
    minDepth: 450,
    maxDepth: 740,
    rarity: 'epic',
    ...
    baseExp: 900,
    sizeRange: [20, 35],
    favBait: ['jelly', 'pearl', 'golden'],
    baitSize: 'small',
    speed: 38,
    strength: 85,
    description: '지구상에서 가장 깊은 초심해 해구 바닥에서 서식하는 반투명 연체 물고기.',
    colors: { body: '#e0e1dd', belly: '#f8f9fa', fin: '#778da9', pattern: '#ffffff' },
    drawType: 'anchovy'
  },
  {
    id: 'cosmic_jelly',
    name: '성운 오로라 해파리',
    engName: 'Nebula Cosmic Jelly',
    zone: 'hadal',
    minDepth: 420,
    maxDepth: 740,
    rarity: 'legendary',
  ...
  // =========================================================
  // --- Zone 6: 👑 10대 전설의 거대 신화 보스 (Mythic Boss Leviathans) ---
  // =========================================================
  {
    id: 'boss_megalodon',
    name: '🦈 고대 포식자 메갈로돈',
    engName: 'Ancient Megalodon Shark',
    zone: 'mid',
    minDepth: 60,
    maxDepth: 140,
    minX: 1600,
    ...
    speed: 60,
    strength: 105,
    description: '고대 대양의 최상위 포식자. 어마어마한 턱 힘과 거대한 몸집으로 바다를 지배하는 전설의 메갈로돈!',
    colors: { body: '#1e293b', belly: '#e2e8f0', fin: '#0f172a', eye: '#ff0054', glow: '#38bdf8' },
    drawType: 'boss_megalodon'
  },
  {
    id: 'boss_magma_turtle',
    name: '🌋 해저 화산 마그마 거북',
    engName: 'Volcanic Magma Turtle',
    zone: 'mid',
    minDepth: 120,
    maxDepth: 220,
    minX: 4200,
    ...
    speed: 35,
    strength: 125,
    description: '해저 화산의 끓어오르는 용암을 등껍질에 품은 거대 마그마 거북. 강력한 화염 앞다리로 바다를 누빕니다.',
    colors: { shell: '#2b2d42', body: '#d90429', magma: '#ff5400', glow: '#ffb703', eye: '#ffffff' },
    drawType: 'boss_magma_turtle'
  },
  {
    id: 'boss_sea_dragon',
    name: '🐉 폭풍의 해신 청룡',
    engName: 'Storm Ocean Dragon',
    zone: 'deep',
    minDepth: 180,
    maxDepth: 300,
    minX: 7200,
    ...
    speed: 70,
    strength: 130,
    description: '푸른 번개와 폭풍우를 부르는 바다의 용신. 길고 웅장한 몸체로 바닷속을 가르며 승천합니다.',
    colors: { body: '#0077b6', belly: '#90e0ef', mane: '#48cae4', horn: '#ffd166', lightning: '#00f5d4' },
    drawType: 'boss_sea_dragon'
  },
  {
    id: 'boss_cosmic_whale',
    name: '🌌 은하 코스믹 고래',
    engName: 'Cosmic Galaxy Whale',
    zone: 'deep',
    minDepth: 250,
    maxDepth: 400,
    minX: 10500,
    ...
    speed: 40,
    strength: 120,
    description: '등에 아름다운 은하수 성운을 품고 유영하는 우주 고래. 꼬리짓 한 번에 별빛이 쏟아져 내립니다.',
    colors: { body: '#240046', belly: '#5a189a', star: '#ffd166', nebula: '#ff007f', fin: '#7b2cbf' },
    drawType: 'boss_cosmic_whale'
  },
  {
    id: 'boss_crystal_angler',
    name: '💎 다이아몬드 크리스탈 아귀',
    engName: 'Crystal Prismatic Angler',
    zone: 'abyss',
    minDepth: 320,
    maxDepth: 480,
    minX: 14000,
    ...
    speed: 45,
    strength: 115,
    description: '찬란한 다이아몬드 크리스탈 빛을 뿜는 전설의 초롱아귀. 보석처럼 영롱한 비늘을 지녔습니다.',
    colors: { body: '#00b4d8', belly: '#90e0ef', crystal: '#e0aaff', lamp: '#ffffff', glow: '#48cae4' },
    drawType: 'boss_crystal_angler'
  },
  {
    id: 'boss_thunder_manta',
    name: '⚡ 뇌신 심해 만타가오리',
    engName: 'Thunder God Manta',
    zone: 'abyss',
    minDepth: 400,
    maxDepth: 560,
    minX: 17800,
    ...
    speed: 65,
    strength: 120,
    description: '양 날개 끝에서 푸른 뇌전을 파지직 방출하며 심해를 날아다니는 신비로운 뇌신 만타가오리!',
    colors: { body: '#03045e', belly: '#caf0f8', wing: '#0077b6', spark: '#00f5d4', eye: '#ffd166' },
    drawType: 'boss_thunder_manta'
  },
  {
    id: 'boss_ghost_phantom',
    name: '👻 유령선 저주받은 심해어',
    engName: 'Cursed Ghost Phantom',
    zone: 'hadal',
    minDepth: 480,
    maxDepth: 620,
    minX: 21800,
    ...
    speed: 50,
    strength: 130,
    description: '바다 밑 침몰한 유령선의 저주를 받아 반투명한 에메랄드 영혼 불꽃을 두른 불사의 유령 보스 물고기!',
    colors: { body: '#06d6a0', belly: '#118ab2', soul: '#073b4c', eye: '#ffd166', flame: '#70e000' },
    drawType: 'boss_ghost_phantom'
  },
  {
    id: 'boss_kraken_king',
    name: '🐙 심연의 크라켄 제왕',
    engName: 'Abyssal Kraken King',
    zone: 'hadal',
    minDepth: 550,
    maxDepth: 680,
    minX: 25800,
    ...
    speed: 55,
    strength: 135,
    description: '10개의 거대한 심해 촉수와 붉은 눈을 번뜩이며 수많은 배를 침몰시킨 심연의 지배자!',
    colors: { body: '#9d0208', belly: '#d00000', crown: '#ffd166', eye: '#ffba08', tentacle: '#6a040f' },
    drawType: 'boss_kraken_king'
  },
  {
    id: 'boss_trench_serpent',
    name: '🪐 해구의 심연 리바이어던',
    engName: 'Abyss Trench Leviathan',
    zone: 'hadal',
    minDepth: 620,
    maxDepth: 720,
    minX: 28800,
    ...
    speed: 50,
    strength: 145,
    description: '빛조차 닿지 않는 극심연 해구에 도사리는 고대 바다뱀. 암흑 에너지를 방출하는 거대한 괴수입니다.',
    colors: { body: '#10002b', belly: '#3c096c', spine: '#7b2cbf', eye: '#ff0054', rune: '#c77dff' },
    drawType: 'boss_trench_serpent'
  },
  {
    id: 'boss_chronos_whale',
    name: '⏳ 시공간의 크로노스 고래',
    engName: 'Chronos Time Whale',
    zone: 'hadal',
    minDepth: 680,
    maxDepth: 750,
    minX: 30900,
    ...
    speed: 45,
    strength: 160,
    description: '태초의 시간과 공간을 헤엄쳐온 전설 속 최후의 신화 보스. 750m 해저 바닥 최심연에 거주하며 몸 주변으로 황금 시계 톱니가 회전합니다.',
    colors: { body: '#ffd166', belly: '#ffe8d6', gear: '#d4a373', rune: '#ff0054', eye: '#38bdf8' },
    drawType: 'boss_chronos_whale'
  }
];
